...
def check_point(list01):
    ...
    if check_column(list01) == -1 and flag:  # 高斯消去結束點
        print("break")
        return -1


def check_column(list01):
    checksum = 0
    is0 = 0  # 計算0
    is1 = 0  # 計算1
...
def print_a(list01):
    ...
    print("z = " + str(list01[len(list01) - 1][len(list01[0]) - 1] / list01[len(list01) - 1][len(list01[0]) - 2]))
