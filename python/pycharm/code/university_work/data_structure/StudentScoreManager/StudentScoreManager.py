...
class StudentModel:
    ...
    def __init__(self, name="", score=0, subject=0, id=0):
        self.name = name
        self.score = score
...
class StudentManagerController:
    ...
    def add_base_stu(self, sub):
        ...
        :param sub: 需要添加的科目
        """
        std_name = ["魏零一", "魏零二", "魏零三", "魏零四", "魏零五", "魏零六", "魏零七", "魏零八", "魏零九", "魏零十", "魏十一", "魏十二", "魏十三", "魏十四",
                    "魏仲彥"]
        std_score = [86, 87, 80, 89, 95, 72, 95, 93, 40, 70, 99, 66, 53, 79, 100]
        ...
        for i in range(len(std_name)):
            self.add_student(StudentModel(std_name[i], std_score[i]), sub)
